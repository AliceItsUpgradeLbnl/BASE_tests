...
for i in range(1, len(ADC0all), 1):
  if ((ADC0all[i]) > 0.15) :
...
for i in range(0, len(ADC1all), 1):
  if ((ADC1all[i]) > 0.15) :
...
for i in range(0, len(ADC2all), 1):
  if ((ADC2all[i]) > 0.15) :
...
for i in range(0, len(ADC3all), 1):
  if ((ADC3all[i]) > 0.15) :
...
for i in range(0, len(ADC4all), 1):
  if ((ADC4all[i]) > 0.15) :
...
for i in range(0, len(ADC5all), 1):
  if ((ADC5all[i]) > 0.15) :
...
for i in range(0, len(ADC6all), 1):
  if ((ADC6all[i]) > 0.15) :
...
for i in range(0, len(ADC7all), 1):
  if ((ADC7all[i]) > 0.15) :
...
for i in range(0, len(ADC8all), 1):
  if ((ADC8all[i]) > 0.15) :
...
for i in range(0, len(ADC9all), 1):
  if ((ADC9all[i]) > 0.15) :
...
for i in range(0, len(ADC10all), 1):
  if ((ADC10all[i]) > 0.15) :
...
for i in range(0, len(ADC11all), 1):
  if ((ADC11all[i]) > 0.15) :
...
for i in range(0, len(ADC12all), 1):
  if ((ADC12all[i]) > 0.15) :
...
for i in range(0, len(ADC13all), 1):
  if ((ADC13all[i]) > 0.15) :
...
for i in range(0, len(ADC14all), 1):
  if ((ADC14all[i]) > 0.15) :
...
for i in range(0, len(ADC15all), 1):
  if ((ADC15all[i]) > 0.15) :
...
for i in range(0, len(ADC16all), 1):
  if ((ADC16all[i]) > 0.15) :
...
for i in range(0, len(ADC17all), 1):
  if ((ADC17all[i]) > 0.15) :
...
for i in range(0, len(ADC18all), 1):
  if ((ADC18all[i]) > 0.15) :
...
for i in range(0, len(ADC19all), 1):
  if ((ADC19all[i]) > 0.15) :
...
for i in range(0, len(ADC20all), 1):
  if ((ADC20all[i]) > 0.15) :
...
for i in range(0, len(ADC21all), 1):
  if ((ADC21all[i]) > 0.15) :
...
for i in range(0, len(ADC22all), 1):
  if ((ADC22all[i]) > 0.15) :
...
for i in range(0, len(ADC23all), 1):
  if ((ADC23all[i]) > 0.15) :
...
for i in range(0, len(ADC24all), 1):
  if ((ADC24all[i]) > 0.15) :
...
for i in range(0, len(ADC25all), 1):
  if ((ADC25all[i]) > 0.15) :
...
for i in range(0, len(ADC26all), 1):
  if ((ADC26all[i]) > 0.15) :
...
for i in range(0, len(ADC27all), 1):
  if ((ADC27all[i]) > 0.15) :
...
for i in range(0, len(ADC28all), 1):
  if ((ADC28all[i]) > 0.15) :
...
for i in range(0, len(ADC29all), 1):
  if ((ADC29all[i]) > 0.15) :
...
for i in range(0, len(ADC30all), 1):
  if ((ADC30all[i]) > 0.15) :
...
for i in range(0, len(ADC31all), 1):
  if ((ADC31all[i]) > 0.15) :
